...
references, kept in the repo so the rationale behind the plugin is auditable and
the platform facts are recoverable. They are **not** shipped in the npm package.

| Document | What it covers |
| --- | --- |
| [opencode-plugin-platform.md](opencode-plugin-platform.md) | Verified OpenCode plugin-runtime facts (hooks, discovery, permissions, tools) from `@opencode-ai/plugin@1.15.13` source. The ground truth the plugin is built against. |
